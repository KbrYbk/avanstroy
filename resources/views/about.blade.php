...
<section class="container my-5" id="onas">
    <div class="card"><!--карточка блока "О нас"-->
        <img class="man" src="{{url('img')}}/chelic.jpg" alt="О нас"><!--изображение-->
        <div class="card-body">
...
<section class="container my-5" id="izdelia">
    ...
    <div class="row"><!--сетка товаров-->
        ...
        @endforeach
        <a class="btn btn-light btn-lg btn-block mt-2" href="{{url('catalog')}}" role="button">Каталог наших изделий</a><!--кнопка на весь ассортитмент товара-->
    </div>
</section>
<!-- _________________________________________________________________________________________________ -->
<section class="container my-5">
    ...
    <div class="row my-5">
        <div class="col-md-4 mb-4">
            <img class="prosmotr w-100 " src="{{url('img')}}/nasharabota (1).png" alt="Блоки">
        </div>
        <div class="col-md-4 mb-4">
            <img class="prosmotr w-100 " src="{{url('img')}}/nasharabota (2).png" alt="Блоки">
        </div>
        <div class="col-md-4 mb-4">
            <img class="prosmotr w-100 " src="{{url('img')}}/nasharabota (3).png" alt="Блоки">
        </div>
    </div>
</section>
<!-- _________________________________________________________________________________________________ -->
