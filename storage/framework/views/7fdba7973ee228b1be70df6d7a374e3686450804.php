...
<div class="container my-5">
    <h2 class="title my-5">Каталог изделий</h2>
    

    <div class="row">
    <div class="catalog_sort my-3">
        <div class="dropdown float-md-start">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><!--фильтр по категориям-->
                <a class="dropdown-item" href="<?php echo e(url('catalog/category')); ?>/<?php echo e($category->id); ?>" role="button"><?php echo e($category->name); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>

        <div class="my-3 float-md-end">
            <a href="<?php echo e(url('/catalog')); ?>?sort_by=name&sort_order=<?php echo e($sort_by == 'name' && $sort_order == 'asc' ? 'asc' : 'asc'); ?>">Сортировка по имени</a> |
            <a href="<?php echo e(url('/catalog')); ?>?sort_by=price&sort_order=<?php echo e($sort_by == 'price' && $sort_order == 'asc' ? 'desc' : 'asc'); ?>">Сортировка по цене</a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\avanstroy\resources\views/catalog.blade.php ENDPATH**/ ?>