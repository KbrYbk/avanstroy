    ...
    <div class="blck card"><!--карточка-->
        <div class="row align-items-center justify-content-center"><!--делает объекты в карточке горизонтально-->
            <div class="col-md-3"><!--колонка внутри карточки с картинкой-->
                <img class="w-100" src="<?php echo e(url('img/product')); ?>/<?php echo e($product->img); ?>" alt="<?php echo e($product->name); ?>"><!--картинка товара-->
            </div>
            <div class="col-md-8"><!--колонка внутри карточки с именем, описанием и ценой товара-->
                <div class="card-body">
                    <h2 class="card-title"><?php echo e($product->name); ?></h2><!--название товара-->
                    <p class="card-text onas"> <?php echo e($product->description); ?> </p><!--описание товара-->
                    <h2> от <?php echo e($product->price); ?> ₽</h2><!--цена товара-->
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\avanstroy\resources\views/oneproduct.blade.php ENDPATH**/ ?>