...
<div class="container my-5">
    <h2 class="title my-5"><?php echo e($category->name); ?></h2>



    <div class="row">
        <div class="catalog_sort my-3">
            <a class="btn btn-light btn-lg mb-3 float-md-start" href="<?php echo e(url('catalog')); ?>" role="button">Назад</a>
            <div class="my-3 float-md-end">
                <a href="<?php echo e(url('catalog/'.$category->id.'?sort_by=name&sort_order='.($sort_by == 'name' && $sort_order == 'asc' ? 'desc' : 'asc'))); ?>">Сортировка по имени</a> |
                <a href="<?php echo e(url('catalog/'.$category->id.'?sort_by=price&sort_order='.($sort_by == 'price' && $sort_order == 'asc' ? 'desc' : 'asc'))); ?>">Сортировка по цене</a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\avanstroy\resources\views/catalog-category.blade.php ENDPATH**/ ?>